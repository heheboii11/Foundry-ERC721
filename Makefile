...
deployMood:
	@forge script script/deployMoodNft.s.sol:deployMood $(NETWORK_ARGS)

mintMoodNft:
	@forge script script/InteractionMood.s.sol:MintMood $(NETWORK_ARGS)

flipMoodNft:
	@forge script script/InteractionMood.s.sol:flipMood $(NETWORK_ARGS)